 ...
 */
 ...
 typedef struct EXAMPLE_HTTP_REQUEST {
     ...
     /*!
      * Internal data pointer for request-specific data (e.g., POST body)
      */
     void *request_data;
 ...
 /*! \brief Perform a http GET request asynchronously
  * \ingroup pico_lwip
  *
 ...
 /*! \brief Perform a http GET request synchronously
  * \ingroup pico_lwip
  *
 ...
 /*! \brief Perform a http POST request asynchronously
  * \ingroup pico_lwip
  *
  ...
  * @param content_type The Content-Type header for the POST request (e.g., "application/json").
  * @return If zero is returned the request has been made and is complete when \em req->complete is true or the result callback has been called.
  * A non-zero return value indicates an error.
  *
  * @see async_context
  */
 int http_client_post_request_async(struct async_context *context, EXAMPLE_HTTP_REQUEST_T *req, const char *body, const char *content_type);
 
 /*! \brief Perform a http POST request synchronously
  * \ingroup pico_lwip
  *
  * Perform the http POST request synchronously
  *
  * @param context async context
  * @param req HTTP request parameters. As a minimum this should be initialised to zero with hostname and url set to valid values
  * @param body The body of the POST request.
  ...
  * @param result Returns the overall result of the http request when complete. Zero indicates success.
  */
 int http_client_post_request_sync(struct async_context *context, EXAMPLE_HTTP_REQUEST_T *req, const char *body, const char *content_type);
